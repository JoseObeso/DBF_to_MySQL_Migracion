...
TEXT TO lqry_00 noshow
 truncate table bdcontratos.tmp_tabla_cta_eliminar_ampliacion
ENDTEXT
lejecutabusca = sqlexec(gconecta,lqry_00)

TEXT TO lqry_01x noshow
  SELECT * FROM bdcontratos.mnein where cestado = 'V' AND namplia = 1 AND tiene_cronograma = 'S'
ENDTEXT
...
IF lc_mostrar = '0'
   ...
   IF ln_ver_cp = 1
       TEXT TO lqry_03 noshow
           INSERT INTO bdcontratos.tmp_tabla_cta_eliminar_ampliacion (idcuenta)
