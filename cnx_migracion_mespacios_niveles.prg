...
*!*	           insert into bdcontratos.mespacioniveles(crespacio, nnivel, nusado, nreservado, usuarioregistro)
*!*	           values (?lc_nrespacio, ?t, 0, 0, ?lcuser);
*!*	       endtext
...
*!*	            select  idcontrato  from bdcontratos.mnein where cnroespa = ?lc_nrespacio AND idcontrato NOT in (?lc_con41, ?lc_con42, ?lc_con34)        
*!*	         ENDTEXT
