...
TEXT TO lqry_01 noshow
   SELECT * FROM bdcontratos.mnein WHERE tiene_cronograma = 'S' and cestado = 'V'
ENDTEXT
...
ELSE
      ...
      ?"CUENTA : " + lc_idcontrato + " TIENE ALGUNOS PAGOS REALIZADOS"
...
ENDSCAN
   ?' --- FIN DE GRABACION DE CUENTAS ELIMINAR '
