...
*!*	 SELECT * FROM bdcontratos.tabla_sigesco where ccodper = '' ORDER BY razon_social;
*!*	ENDTEXT
*!*	lejecutabusca = sqlexec(gconecta,lqry_ver_clientes, "tver_sigesco")
*!*	SELECT tver_sigesco
*!*	GO top
*!*	SCAN
*!*	    lc_cdni = ALLTRIM(tver_sigesco.ruc)
*!*	    TEXT TO lqry_ubicar noshow
*!*	      SELECT * FROM bdcontratos.mpersonas where cdni = ?lc_cdni
*!*	    ENDTEXT
