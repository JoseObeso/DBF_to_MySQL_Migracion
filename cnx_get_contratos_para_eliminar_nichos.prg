...
TEXT TO lqry_00 noshow
 truncate table bdcontratos.tmp_tabla_cta_eliminar_nicho
 ENDTEXT
 
lejecutabusca = sqlexec(gconecta,lqry_00)

TEXT TO lqry_01x noshow
  SELECT * FROM bdcontratos.mnein where substr(idcontrato,12,1) = 'C'   and cestado = 'V'
ENDTEXT
...
IF lc_mostrar = '0'
   ...
   IF ln_ver_cp = 1
       TEXT TO lqry_03 noshow
           INSERT INTO bdcontratos.tmp_tabla_cta_eliminar_nicho (idcuenta)
